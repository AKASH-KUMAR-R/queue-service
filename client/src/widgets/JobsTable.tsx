  ...
  const jobs: Job[] = [
    {
      ...
      completedAt: null,
      payload: { userId: 'usr_123', emailType: 'welcome', template: 'v2' },
    },
    {
      id: 'job_b4n7p1k9',
      status: 'completed',
    ...
    },
    {
      ...
      startedAt: null,
      completedAt: null,
      payload: { userId: 'usr_101', emailType: 'digest', frequency: 'daily' },
    },
    {
      id: 'job_e5m1k9n3',
      status: 'scheduled',
        ...
        <table className="w-full">
          <thead className="bg-neutral-50 border-b border-neutral-200 sticky top-0">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-neutral-600 uppercase tracking-wider">Job ID</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-neutral-600 uppercase tracking-wider">Status</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-neutral-600 uppercase tracking-wider">Attempts</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-neutral-600 uppercase tracking-wider">Priority</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-neutral-600 uppercase tracking-wider">Scheduled</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-neutral-600 uppercase tracking-wider">Started</th>
