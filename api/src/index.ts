...
import environmentRouter from "@routes/environment/environment.routes";
...
import { startQueueMetricsCronJob } from "./scheduler/queue-metrics";
...
app.use("/api/dashboard/environment", environmentRouter);
